"""
Created on Fri Sep 20 11:17:02 2024
...
stacked_forecasts_static_mean_profile = pd.read_pickle('./data/results/stacked_forecasts_static_mean.pkl')
stacked_forecasts_rolling_mean_profile = pd.read_pickle('./data/results/stacked_forecasts_rolling_mean.pkl')
...
#stacked_forecasts_sorcerer_MAP = pd.read_pickle('./data/results/stacked_forecasts_sorcerer_MAP_new_data_split.pkl')
#stacked_forecasts_sorcerer_MAP = pd.read_pickle('./data/results/stacked_forecasts_sorcerer_MAP_new_data_split.pkl')
...
time_series_titles = abs_mean_gradient_training_data.index.values
number_of_time_series = len(abs_mean_gradient_training_data)
...
MASE_std_over_time_series = np.zeros((len(list_of_models_forecasts),max(stacked_forecasts_static_mean_profile.index)+1))
MASE_averaged_over_time_series = np.zeros((len(list_of_models_forecasts),max(stacked_forecasts_static_mean_profile.index)+1))
for j in range(len(list_of_models_forecasts)):
